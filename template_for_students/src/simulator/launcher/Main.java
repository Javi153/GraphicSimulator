...
public class Main {
	...
	private static void parseArgs(String[] args) {
		...
		try {
			...
			// esta mal en la entrada por la l√≠nea de comandos
			//
	...
	private static Options buildOptions() {
		...
		cmdLineOptions.addOption(Option.builder("m").longOpt("mode").hasArg()
				.desc("Execution Mode. Possible values: íbatchí (Batch mode), íguií (Graphical User Interface mode). Default value: íbatchí.").build());
	...
	/*Metodos nuevos*/
	/**
	 * Parsea la entrada de la l√≠nea de comandos para el valor 'o' 
	 * @param line	L√≠nea de comandos
	 * @throws ParseException	Se devuelve esta excepci√≥n si el archivo de salida no se ha cargado bien
	 */
	...
	/**
	 * 
	 * Parsea la entrada de la l√≠nea de comandos par el valor "eo"
	 * @param line	L√≠nea de comandos
	 * @throws ParseException	Se devuelve esta excepci√≥n si el archivo no se ha cargado bien
	 */
